...
class AppTest {
    ...
    void testGetWordsCount() {
        ...
        var actual1 = App.getWordCount(sentence1);
        ...
        String sentence2 = "";
        var actual2 = App.getWordCount(sentence2);
    ...
    void testToString() {
        ...
        var wordCount1 = App.getWordCount(sentence1);
        ...
        var wordCount2 = App.getWordCount(sentence2);
        ...
        String sentence3 = "";
        var wordCount3 = App.getWordCount(sentence3);
