...
public class App {
    ...
    public static Tomcat getApp(int port) {
        ...
        // BEGIN
        Tomcat.addServlet(ctx, "SessionServlet", new SessionServlet());
        ctx.addServletMappingDecoded("/login", "SessionServlet");
        ctx.addServletMappingDecoded("/logout", "SessionServlet");
        // END
